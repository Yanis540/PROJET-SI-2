...
function ContenuActeNaissance({acte,acte_naissance}) {
    const {mere:acte_naissance_mere,pere:acte_naissance_pere}=acte_naissance;
    return (
...
export default ContenuActeNaissance